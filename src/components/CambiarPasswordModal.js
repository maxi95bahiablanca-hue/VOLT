        ...
        <View style={styles.sheet}>
          <ScrollView keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Ionicons name={verla ? 'eye-off-outline' : 'eye-outline'} size={16} color="#888" />
...
const styles = StyleSheet.create({
  ...
  verlaText:{ color: '#888', fontSize: 13 },
  aviso:    { color: '#FF9800', fontSize: 12.5, marginBottom: 10 },
  saveBtn:  { backgroundColor: '#FFD600', borderRadius: 14, padding: 16, alignItems: 'center', marginTop: 6 },
