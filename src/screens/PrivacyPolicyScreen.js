...
const SECTIONS = [
  ...
  {
    title: '4. Pagos',
    body: 'Los pagos son procesados por Mercado Pago. BOLT retiene el pago hasta que el cliente confirma que el trabajo fue completado satisfactoriamente. Consultá la política de privacidad de Mercado Pago para más detalles sobre el manejo de datos de pago.',
  },
  {
    title: '5. Ubicación',
  ...
  {
    title: '6. Seguridad',
    body: 'Usamos cifrado TLS para todas las comunicaciones. Los documentos de identidad se almacenan de forma segura en Supabase Storage con acceso restringido. Solo el equipo de BOLT puede ver los documentos de verificación, y únicamente para el proceso de aprobación de trabajadores.',
  },
  {
    title: '7. Retención de datos',
    body: 'Conservamos tu información mientras tu cuenta esté activa. Podés solicitar la eliminación de tu cuenta y datos enviando un email a soporte@bolt.com.ar. Los datos de pagos se conservan por el período requerido por la legislación argentina.',
  },
  {
    title: '8. Tus derechos',
    body: 'Tenés derecho a acceder, corregir o eliminar tu información personal. Para ejercer estos derechos, contactanos en soporte@bolt.com.ar. Respondemos todas las solicitudes dentro de los 30 días hábiles.',
  },
  {
    title: '9. Cambios a esta política',
    body: 'Podemos actualizar esta política ocasionalmente. Te notificaremos por email o dentro de la app si hay cambios significativos. El uso continuado de BOLT después de los cambios implica aceptación de la nueva política.',
  },
  {
    title: '10. Contacto',
    body: 'Para preguntas sobre esta política de privacidad, contactanos en soporte@bolt.com.ar o desde el menú de soporte dentro de la app.',
  },
];
  ...
  <SafeAreaView style={styles.container}>
    ...
    <ScrollView contentContainerStyle={styles.content}>
      ...
      <Text style={styles.intro}>
        En BOLT nos tomamos muy en serio la privacidad de nuestros usuarios. Esta política explica qué información recopilamos, cómo la usamos y cómo la protegemos.
      </Text>
